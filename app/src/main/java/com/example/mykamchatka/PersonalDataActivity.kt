...
class PersonalDataActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnNext.setOnClickListener{
            ...
            userBundle.putString(PersonalDataActivity.SURNAME, surname)
            userBundle.putString(PersonalDataActivity.NAME, name)
            userBundle.putString(PersonalDataActivity.THIRDNAME, thirdname)
            userBundle.putString(PersonalDataActivity.BIRTHDAY, birthday)
